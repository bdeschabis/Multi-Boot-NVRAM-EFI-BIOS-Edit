...
table_commentaire.append("Use Refind to see all usable launchers at boot time, and efibootmgr or the present script to reorder them.")
...
table_commentaire.append("signature of every file xxxx.efi before launching it. However, this checking can be avoided by activating")
table_commentaire.append("the CSM option of the BIOS (CSM: Compatibility Support Module) in order to start an OS with a")
table_commentaire.append("non signed launcher")
